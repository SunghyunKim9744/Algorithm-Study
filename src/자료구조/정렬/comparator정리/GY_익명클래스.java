...
public class GY_익명클래스 {
	...
	public static void main(String[] args) {
		...
		List<Person4> list = new LinkedList<>();

		list.add(new Person4(170, 56));
		list.add(new Person4(190, 54));
		list.add(new Person4(130, 87));
		list.add(new Person4(120, 47));
		list.add(new Person4(210, 72));
...
class Person4 implements Comparable<Person4>{
	...
	public Person4(int height, int weight) {
		super();
		this.height = height;
		this.weight = weight;
	}
